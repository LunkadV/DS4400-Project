...
from src.main.models.randomForest.model import get_model
from src.main.evaluate import cross_validate_model, compute_metrics, plot_confusion_matrix, save_results


RESULTS_PATH = str(PROJECT_ROOT / "results" / "random_forest.json")
MODEL_PATH = str(PROJECT_ROOT / "results" / "random_forest.joblib")
...
if __name__ == "__main__":
    ...
    best_params["max_depth"] = best_params.get("max_depth", None)  # Optuna returns int, ensure None is preserved
    ...
    plot_confusion_matrix(y_test, y_pred, encoder, title="Random Forest — Confusion Matrix",
